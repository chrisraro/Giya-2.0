  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    try {
      ...
      try {
        ...
        console.error("[identity] device registration threw during admin sign-in", devErr);
      }
      ...
      if (!adminData) {
        setFormError(`Access Denied: ${email} is not a registered Platform Admin.`);
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center p-4">
      <AuthCard
        ...
        subtitle="Access the Giya Platform Admin back-office."
      >
        <SocialButtons
        ...
        <div className="mt-4 text-center">
          <Link href="/login" className="text-label-m text-primary hover:underline">
            Consumer / Merchant Login →
          </Link>
        </div>
      </AuthCard>
    </div>
